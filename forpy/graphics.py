...
def plot_climate_cflux(cflux_data: Tuple, climate_data: np.array, time: np.array, plot_path:str=".")-> None:
    ...
    t = 300
    av_rain = climate_data[0,t:]
    av_temp = climate_data[1,t:]
    av_irradiance = climate_data[2,t:]
    time = time[t:]
    # Multiplying by 100 for unit conversion 
    nee_arr = nee_arr[t:]*100
    gpp_arr = gpp_arr[t:]*100
    biomass_arr = biomass_arr[t:]*100
    deadwood_arr = deadwood_arr[t:]*100
    if t>0:
